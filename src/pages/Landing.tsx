        ...
        >
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button
              ...
              className="rounded-2xl bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 text-white shadow-lg shadow-indigo-500/25 transition-all h-10 md:h-12 px-6 font-bold border-0"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <motion.h1
              ...
              className="text-6xl md:text-[5.5rem] font-black mb-6 leading-[1.05] tracking-tighter text-zinc-900 dark:text-white"
            >
              Trustless <br className="hidden md:block" />
            ...
            <motion.p
              ...
              className="text-lg md:text-2xl text-zinc-600 dark:text-zinc-400 mb-10 max-w-2xl leading-relaxed font-medium"
            >
          ...
          <div className="lg:col-span-5 relative hidden lg:block h-[600px] flex items-center justify-center">
            {/* Glowing Orb Background behind globe */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-br from-sky-400/30 to-indigo-500/20 dark:from-indigo-600/20 dark:to-sky-500/10 blur-[100px] rounded-full z-0 animate-pulse transition-colors duration-700"></div>
            ...
            <div className="absolute inset-0 z-0 flex items-center justify-center opacity-90 transition-opacity duration-700">
              <svg
                viewBox="0 0 400 400"
                className="w-[500px] h-[500px] animate-[spin_60s_linear_infinite]"
              >
                <circle
                  cx="200"
                  cy="200"
